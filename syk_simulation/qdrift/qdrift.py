...
def qdrift(
    hamiltonian: PauliSum, qubits: Qubits, ppr_instance, time: float, num_samples: int, random_seed: int | None = None
) -> None:
    """
...
def qdrift_with_epsilon(
    hamiltonian: PauliSum, qubits: Qubits, ppr_instance, time: float, epsilon: float, random_seed: int | None = None
) -> int:
    """
...
def qdrift_vs_trotter_cost(hamiltonian: PauliSum, time: float, epsilon: float) -> dict:
    """
