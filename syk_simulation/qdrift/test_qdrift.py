...
from syk_simulation.qdrift import qdrift, qdrift_with_epsilon, qdrift_vs_trotter_cost
...
def test_qdrift_convergence():
    ...
    assert avg_late >= avg_early - 0.05, "Later samples should have similar or better average fidelity"
...
def test_qdrift_with_epsilon():
    ...
    num_samples = qdrift_with_epsilon(hamiltonian, qubits, ppr, time, epsilon, random_seed=42)
